# Terraform configuration for Video Coaching Platform VPC infrastructure
...
locals {
  name_prefix = "${var.environment}-videocoach"
  common_tags = {
...
# Main VPC resource with DNS and networking features enabled
